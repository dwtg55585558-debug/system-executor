...
export default function SystemCheckModal({ riskCheck, onRespond }) {
  return (
    <div
      className="fixed inset-0 z-40 flex items-center justify-center px-6"
      style={{ background: "rgba(0,0,0,0.68)" }}
    >
      <div className="rounded-2xl p-5 w-full max-w-xs" style={{ background: C.raised2, border: `1px solid ${C.violetDim}` }}>
